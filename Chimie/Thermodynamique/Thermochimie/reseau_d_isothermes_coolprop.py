...
def isothermes_d_andrews(fluide, dico={}):
    ...
    * 'saturation': Booléen indiquant si on veut rajouter la courbe de
    ...
    DEFAUTS = {'vmin': vtripleL, 'vmax': vtripleG * 10,
               ...
               'fichier': 'T2_reseau_d_isothermes_coolprop_{}.png'.format(fluide),
...
# fluide
dico = {'Prange': (1e7, 3e7),
        'fichier': 'T2_reseau_d_isothermes_coolprop_{}_lin.png'.format(fluide),
...
dico[
    'fichier'] = 'T2_reseau_d_isothermes_coolprop_{}_lin_sat.png'.format(fluide)
isothermes_d_andrews(fluide, dico)
