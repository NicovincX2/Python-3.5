...
# Entropie de la détente isentropique
S3 = CP.PropsSI('S', 'T', TF, 'P', P0, gaz)
# Entropie de la compression isentropique
S1 = CP.PropsSI('S', 'T', TC, 'P', Pmax, gaz)
...
plt.savefig('T6_cycle_de_carnot_reel_et_GP_{}.png'.format(gaz))
