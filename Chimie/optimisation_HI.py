...
class MplCanvas(FigureCanvas):
    ...
    def __init__(self, parent=None):
        ...
        self.l_tableau_rdt, = self.axes.plot(
            self.tableau_parametre, self.tableau_rdt, color="0.25", linestyle="-", linewidth="2", label="Rendement")
        self.l_tableau_xHI, = self.axes.plot(
            self.tableau_parametre, self.tableau_xHI, color="red", linestyle="-", linewidth="2", label="x(HI)")
        self.l_tableau_aI2, = self.axes.plot(
            self.tableau_parametre, self.tableau_xHI, color="blue", linestyle=":", linewidth="4", label="alpha(I2)")
        self.l_tableau_aH2, = self.axes.plot(
            self.tableau_parametre, self.tableau_xHI, color="green", linestyle="--", linewidth="3", label="alpha(H2)")
        self.axes.legend()
...
class FenetrePrincipale(QWidget):
    ...
    def __init__(self):
        ...
        self.doubleSpinBox_n_init.setButtonSymbols(
        ...
        self.doubleSpinBox_rapportH2I2.setButtonSymbols(
            QtGui.QAbstractSpinBox.NoButtons)
        ...
        self.doubleSpinBox_Ptot.setButtonSymbols(
            QtGui.QAbstractSpinBox.NoButtons)
        ...
        self.glayout_P_T.addWidget(
            QLabel("<b>Parametres initiaux :<>"), 0, 0, 1, -1)
        self.glayout_P_T.addWidget(
            QLabel("n(I2) + n(H2) :"), 1, 0, QtCore.Qt.AlignLeft)
        self.glayout_P_T.addWidget(
            self.doubleSpinBox_n_init, 1, 1, QtCore.Qt.AlignRight)
        self.glayout_P_T.addWidget(
            QLabel("Pression :"), 1, 3, QtCore.Qt.AlignLeft)
        self.glayout_P_T.addWidget(
            self.doubleSpinBox_Ptot, 1, 4, QtCore.Qt.AlignRight)
        self.glayout_P_T.addWidget(
            QLabel("n(H2) / n(I2) :"), 2, 0, QtCore.Qt.AlignLeft)
        self.glayout_P_T.addWidget(
            self.doubleSpinBox_rapportH2I2, 2, 1, QtCore.Qt.AlignRight)
        self.glayout_P_T.addWidget(
            QLabel("Temperature :"), 2, 3, QtCore.Qt.AlignLeft)
        self.glayout_P_T.addWidget(
            self.doubleSpinBox_T, 2, 4, QtCore.Qt.AlignRight)
        ...
        self.connect(self.radio_ntot, SIGNAL(
            "toggled(bool)"), self.slot_radio_ntot)
        self.connect(self.radio_rapportH2I2, SIGNAL(
            "toggled(bool)"), self.slot_radio_rapportH2I2)
        self.connect(self.radio_Ptot, SIGNAL(
            "toggled(bool)"), self.slot_radio_Ptot)
        ...
        self.doubleSpinBox_variation_1.setButtonSymbols(
            QtGui.QAbstractSpinBox.NoButtons)
        self.doubleSpinBox_variation_1.setDecimals(
            self.doubleSpinBox_rapportH2I2.decimals())
        self.doubleSpinBox_variation_1.setRange(
            self.doubleSpinBox_rapportH2I2.minimum(), self.doubleSpinBox_rapportH2I2.maximum())
        self.doubleSpinBox_variation_1.setValue(
            self.doubleSpinBox_rapportH2I2.minimum())

        self.doubleSpinBox_variation_2 = QDoubleSpinBox()
        self.doubleSpinBox_variation_2.setAlignment(QtCore.Qt.AlignRight)
        self.doubleSpinBox_variation_2.setButtonSymbols(
            QtGui.QAbstractSpinBox.NoButtons)
        self.doubleSpinBox_variation_2.setDecimals(
            self.doubleSpinBox_rapportH2I2.decimals())
        self.doubleSpinBox_variation_2.setRange(
            self.doubleSpinBox_rapportH2I2.minimum(), self.doubleSpinBox_rapportH2I2.maximum())
        self.doubleSpinBox_variation_2.setValue(
            self.doubleSpinBox_rapportH2I2.maximum())

        self.hlayout_variation_1 = QHBoxLayout()
        self.hlayout_variation_1.addWidget(
            QLabel("Faire varier le parametre de "))
        ...
        self.doubleSpinBox_variation_pas.setButtonSymbols(
            QtGui.QAbstractSpinBox.NoButtons)
        self.doubleSpinBox_variation_pas.setDecimals(
            self.doubleSpinBox_rapportH2I2.decimals())
        self.doubleSpinBox_variation_pas.setRange(self.doubleSpinBox_rapportH2I2.minimum(
        ), self.doubleSpinBox_rapportH2I2.maximum() / 2)
        self.doubleSpinBox_variation_pas.setValue(
            self.doubleSpinBox_rapportH2I2.minimum())
        ...
        self.connect(self.bouton_calculer, SIGNAL(
            "clicked(bool)"), self.slot_calculer)
        ...
        self.vlayout_parametres.addWidget(
            QLabel("I2 (g) + H2 (g) = 2 HI (g)"), 0, QtCore.Qt.AlignHCenter)
        self.vlayout_parametres.addLayout(self.glayout_P_T)
        self.vlayout_parametres.addSpacing(20)
        self.vlayout_parametres.addWidget(
            QLabel("<b>Variation d'un des parametres initiaux :<>"))
        ...
        self.vlayout_principal.addWidget(
            QLabel("Y. Loquais"), 0, QtCore.Qt.AlignRight)
    ...
    def slot_radio_ntot(self):
        ...
        self.doubleSpinBox_variation_1.setDecimals(
            self.doubleSpinBox_n_init.decimals())
        self.doubleSpinBox_variation_1.setRange(
            self.doubleSpinBox_n_init.minimum(), self.doubleSpinBox_n_init.maximum())
        self.doubleSpinBox_variation_1.setValue(
            self.doubleSpinBox_n_init.minimum())
        self.doubleSpinBox_variation_2.setDecimals(
            self.doubleSpinBox_n_init.decimals())
        self.doubleSpinBox_variation_2.setRange(
            self.doubleSpinBox_n_init.minimum(), self.doubleSpinBox_n_init.maximum())
        self.doubleSpinBox_variation_2.setValue(
            self.doubleSpinBox_n_init.maximum())
        self.doubleSpinBox_variation_pas.setDecimals(
            self.doubleSpinBox_n_init.decimals())
        self.doubleSpinBox_variation_pas.setRange(
            self.doubleSpinBox_n_init.minimum(), self.doubleSpinBox_n_init.maximum() / 2)
        self.doubleSpinBox_variation_pas.setValue(
            self.doubleSpinBox_n_init.minimum())
        self.qmc.axes.set_xlabel(
            "Quantite de matiere totale initiale n(I2) + n(H2) (en mol)")
    ...
    def slot_radio_Ptot(self):
        ...
        self.doubleSpinBox_T.setEnabled(True)
        self.doubleSpinBox_variation_1.setDecimals(
            self.doubleSpinBox_Ptot.decimals())
        self.doubleSpinBox_variation_1.setRange(
            self.doubleSpinBox_Ptot.minimum(), self.doubleSpinBox_Ptot.maximum())
        self.doubleSpinBox_variation_1.setValue(
            self.doubleSpinBox_Ptot.minimum())
        self.doubleSpinBox_variation_2.setDecimals(
            self.doubleSpinBox_Ptot.decimals())
        self.doubleSpinBox_variation_2.setRange(
            self.doubleSpinBox_Ptot.minimum(), self.doubleSpinBox_Ptot.maximum())
        self.doubleSpinBox_variation_2.setValue(
            self.doubleSpinBox_Ptot.maximum())
        self.doubleSpinBox_variation_pas.setDecimals(
            self.doubleSpinBox_Ptot.decimals())
        self.doubleSpinBox_variation_pas.setRange(
            self.doubleSpinBox_Ptot.minimum(), self.doubleSpinBox_Ptot.maximum() / 2)
        self.doubleSpinBox_variation_pas.setValue(
            self.doubleSpinBox_Ptot.minimum())
    ...
    def slot_radio_T(self):
        ...
        self.doubleSpinBox_variation_1.setDecimals(
            self.doubleSpinBox_T.decimals())
        self.doubleSpinBox_variation_1.setRange(
            self.doubleSpinBox_T.minimum(), self.doubleSpinBox_T.maximum())
        ...
        self.doubleSpinBox_variation_pas.setDecimals(
            self.doubleSpinBox_T.decimals())
        self.doubleSpinBox_variation_pas.setRange(
            self.doubleSpinBox_T.minimum(), self.doubleSpinBox_T.maximum() / 2)
        self.doubleSpinBox_variation_pas.setValue(
            self.doubleSpinBox_T.minimum())
    ...
    def slot_calculer(self):
        ...
        if self.radio_T.isChecked() == True:
            n_I2_init = self.doubleSpinBox_n_init.value(
            ) / (1 + self.doubleSpinBox_rapportH2I2.value())
            n_H2_init = self.doubleSpinBox_n_init.value() * self.doubleSpinBox_rapportH2I2.value() / \
                (1 + self.doubleSpinBox_rapportH2I2.value())
        ...
        if self.radio_ntot.isChecked() == True:
            ...
            while i - self.doubleSpinBox_variation_pas.value() < self.doubleSpinBox_variation_2.value():
                ...
                n_H2_init = i * self.doubleSpinBox_rapportH2I2.value() / \
                    (1 + self.doubleSpinBox_rapportH2I2.value())
                xi_max = np.minimum(n_I2_init, n_H2_init)
                self.qmc.tableau_parametre.append(i)
                #--Recherche de la valeur de xi telle que qr = k0--
        ...
        self.qmc.axes.set_xlim(self.doubleSpinBox_variation_1.value(
        ), self.doubleSpinBox_variation_2.value())
        self.qmc.l_tableau_rdt.set_data(
            self.qmc.tableau_parametre, self.qmc.tableau_rdt)
        self.qmc.l_tableau_xHI.set_data(
            self.qmc.tableau_parametre, self.qmc.tableau_xHI)
        self.qmc.l_tableau_aI2.set_data(
            self.qmc.tableau_parametre, self.qmc.tableau_aI2)
        self.qmc.l_tableau_aH2.set_data(
            self.qmc.tableau_parametre, self.qmc.tableau_aH2)
