...
ttk.Label(mainframe, background="white", textvariable=area).grid(
    column=2, row=2, sticky=(W, E))
ttk.Button(mainframe, text="Circle", command=calculate3).grid(
    column=3, row=3, sticky=W)
ttk.Button(mainframe, text="Triangle", command=calculate2).grid(
    column=1, row=3, sticky=E)
ttk.Button(mainframe, text="Rectangle",
           command=calculate1).grid(column=2, row=3)
