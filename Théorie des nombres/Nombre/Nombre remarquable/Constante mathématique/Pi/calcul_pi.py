...
# http://codes-sources.commentcamarche.net/source/49370-benchmark-par-le-calcul-de-pi-multithread
...
class GUI:
    ...
    def finir(self, pi, temps, boucles):
        ...
        lbl3.configure(text="Calcul de PI effectué en " +
                       str(temps) + " secondes !!!")
        res.insert(END, str(boucles) + " boucles     " +
                   str(temps) + " secondes\n")
