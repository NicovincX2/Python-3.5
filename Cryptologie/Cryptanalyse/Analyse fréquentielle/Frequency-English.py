...
# https://github.com/bt3gl/My-Gray-Hacker-Resources/blob/patch-1/Cryptography/Rotation-Ciphers/taste_like_english.py
...
def test_values():
    ...
    print('Test for "english": ', taste_like_english(
        dict_letters_test, 'english'))  # == 0.045"
