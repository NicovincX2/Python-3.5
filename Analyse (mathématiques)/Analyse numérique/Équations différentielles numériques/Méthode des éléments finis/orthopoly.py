...
"""
    Set of functions for generating orthogonal polynomials and quadrature rules 
    ...
    Last updated: Tue Sep 24 09:05:48 MDT 2013
...
def jacobiD(N, a, b, x, NOPT=1):
    ...
    if N == 0:
        ...
        Px = 0.5 * np.hstack((z, jacobi(N - 1, a + 1, b + 1,
                                        x, NOPT) * ((a + b + 2 + np.arange(N)))))
    return Px
