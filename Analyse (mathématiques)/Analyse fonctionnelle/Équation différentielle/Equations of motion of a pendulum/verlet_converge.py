...
pylab.plot(numpy.array(dts), err[
           0] * (dts[0] / numpy.array(dts))**-2, label="2nd order scaling")
pylab.plot(numpy.array(dts), err[
           0] * (dts[0] / numpy.array(dts))**-4, ls=":", label="4th order scaling")
pylab.plot(numpy.array(dts), err[
           0] * (dts[0] / numpy.array(dts))**-6, ls="--", label="6th order scaling")
