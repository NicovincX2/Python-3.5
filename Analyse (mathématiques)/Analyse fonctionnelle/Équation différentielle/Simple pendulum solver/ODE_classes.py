...
class pendulumTrajectory:
    ...
    def __init__(self, CONST_theta0, CONST_l, CONST_g, CONST_m):
        # initial condition -> theta0 in degree
        self.theta0_degrees = CONST_theta0
        self.theta0 = self.theta0_degrees * math.pi / \
            180      # convert theta0 to radians
        self.t0 = 0.0                                       # time starts at zero
        # initial condition -> omega0 starts at 0
        self.omega0 = 0.0
