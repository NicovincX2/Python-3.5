...
from ellPDE_part_a import doPartA
from ellPDE_part_b import doPartB, error
from ellPDE_part_c import doPartC
import os
import numpy
...
def main():
    ...
    for i in range(len(nx)):
        ...
        Ustar, Ustar_final, phi_true, Ud = doPartA(
            nx[i], ny[i], ng, dx, dy, DO_PLOTS)
        ...
        doPartC(Ustar_final, phi_num, Ud, nx[i], ny[
                i], xmin, xmax, ymin, ymax, DO_PLOTS)
