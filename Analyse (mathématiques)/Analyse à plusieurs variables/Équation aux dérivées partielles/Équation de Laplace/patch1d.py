...
class grid1d:
    ...
    def __str__(self):
        ...
        return "1-d grid: nx = " + str(self.nx) + ", ng = " + str(self.ng)
...
class ccData1d:
    ...
    def __str__(self):
        ...
        myStr = "cc data: nx = " + str(self.grid.nx) + \
            ", ng = " + str(self.grid.ng) + "\n" + \
            "   nvars = " + str(self.nvar) + "\n" + \
            "   variables: \n"
    ...
    def fillBC(self, name):
        ...
        if (self.BCs[name].xlb == "outflow" or
            ...
            i = 0
            while i < self.grid.ilo:
                self.data[n, i] = self.data[
                    n, self.grid.ihi - self.grid.ng + i + 1]
                i += 1
        ...
        if (self.BCs[name].xrb == "outflow" or
            ...
            while i < 2 * self.grid.ng + self.grid.nx:
                self.data[n, i] = self.data[
                    n, i - self.grid.ihi - 1 + self.grid.ng]
                i += 1
