        ...
        for i in range(8):
            for j in range(8):
                if (i + j) % 2 == 1:
                    ...
                    sColor = color.white
                box(pos=(i, -0.1, j), length=1,
                    height=0.1, width=1, color=sColor)
...
class Rook(Piece):
    ...
    def __init__(self, spos, sColor):
        self.base = cylinder(pos=spos, radius=0.4, length=1,
                             axis=(0, 1, 0), color=sColor)
...
class Knight(Piece):
    ...
    def __init__(self, spos, sColor):
        ...
        box(frame=self.base, pos=(0, 0.4, 0), width=0.4,
            length=0.8, height=0.4, axis=(0, 1, 0), color=sColor)
        cone(frame=self.base, pos=(0, 0.6, 0),
             radius=0.2, axis=(0, 1, 0), color=sColor)
...
class Bishop(Piece):
    ...
    def __init__(self, spos, sColor):
        self.base = frame(pos=spos)
        cylinder(frame=self.base, pos=(0, 0, 0), radius=0.2,
                 length=0.8, axis=(0, 1, 0), color=sColor)
        cone(frame=self.base, pos=(0, 0.8, 0),
             radius=0.2, axis=(0, 1, 0), color=sColor)
...
class Queen(Piece):
    ...
    def __init__(self, spos, sColor):
        self.base = frame(pos=spos)
        cylinder(frame=self.base, pos=(0, 0, 0), radius=0.4,
                 length=1.0, axis=(0, 1, 0), color=sColor)
...
class King(Piece):
    ...
    def __init__(self, spos, sColor):
        self.base = frame(pos=spos)
        cylinder(frame=self.base, pos=(0, 0, 0), radius=0.4,
                 length=1.2, axis=(0, 1, 0), color=sColor)
        box(frame=self.base, height=0.6, width=0.6,
            length=0.6, pos=(0, 1.5, 0), color=sColor)
