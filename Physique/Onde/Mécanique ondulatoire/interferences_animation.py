...
# Action de S1 seule
image2 = py.imshow(S1,  extent=[-lim, lim, -lim, lim])
py.plot([0], y1, 'wo', markersize=5)                        # Position source 1
py.plot([0], y2, 'wo', markersize=5)                        # Position source 2
py.axis([-lim, lim, -lim, lim])                             # Avec axes gradués
# py.axis('off')                                          # ou sans
...
# Action de S2 seule
image3 = py.imshow(S2, extent=[-lim, lim, -lim, lim])
py.plot([0], y1, 'wo', markersize=5)                        # Position source 1
py.plot([0], y2, 'wo', markersize=5)                        # Position source 2
py.axis([-lim, lim, -lim, lim])                             # Avec axes gradués
# py.axis('off')                                          # ou sans
...
anim = animation.FuncAnimation(
    fig, animate, frames=int(10 / delta_t), interval=20)
