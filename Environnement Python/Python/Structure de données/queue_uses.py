...
print(queue)
# You will observe that Mumbai and Kolkata have been en-queued at the end
# of the queue
...
# Given that a Queue is a First In First Out (FIFO) data structure the
# de-queued elements will be London and Paris
...
# You will notice how the first two cities have been removed from the
# Queue, in FIFO order
