...
# set the derivatives of the activation functions for all nodes except the
# output, this is done below
...
for node in ['X1', 'X2', 'H0', 'H1', 'H2', 'O1']:
    print("node {0} has output {1} and error {2}".format(
        node, DG.node[node]['o'], DG.node[node]['e']))
