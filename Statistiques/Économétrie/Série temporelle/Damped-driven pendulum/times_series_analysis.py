...
from tsa_constants import b0, dt, tmax, bstep, path, theta0, q, omegad
from tsa_plotter import plotPhaseSpace, plotDFT
import numpy
import os
...
def main():
    ...
    for i in range(10):
        ...
        # generate plots
        plotPhaseSpace(b, aTheta, aOmega, aT,
                       calculatePowerSpectrum(aTheta), k)
